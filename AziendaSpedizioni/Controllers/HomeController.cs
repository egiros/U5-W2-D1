    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Tracking(string CodiceFiscale, string codTracciamento)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    conn.Open();
                    string query = "SELECT * FROM Spedizioni s JOIN Clienti c ON s.IdCliente = c.idCliente WHERE (c.CodiceFiscale = @CodiceFiscale OR c.PartitaIva = @CodiceFiscale) AND s.codTracciamento = @codTracciamento";
                    SqlCommand cmd = new SqlCommand(query, conn);
